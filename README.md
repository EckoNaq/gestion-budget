...
- **Seuls les mois clos comptent.** Un mois en cours porte un salaire entier et des dépenses partielles : son taux d’épargne est flatteur et son total tronqué, si bien qu’un trophée décroché là-dessus ne voudrait rien dire. Il apparaît donc quand le mois se ferme, pas avant.
- **Le décompte part d’octobre 2023**, date à laquelle le budget a commencé à être vraiment tenu. Ce qui précède traîne dans l’historique sans avoir jamais été suivi : compté, il gonflerait les cumuls et découperait les séries sur des mois fantômes. Chaque trophée porte le mois où il a été gagné, pas celui où on le découvre.
- **Calibrage.** Un premier jeu de seuils, réglé sur des données de test médiocres, laissait l’utilisateur réel à 36 trophées sur 58 dont deux exceptionnels — la collection était pliée avant d’avoir commencé. Les rangs hauts montent donc d’un cran (60 % d’épargne au lieu de 50, quarante-deux mois de série au lieu de trente-six, 200 000 € cumulés au lieu de 120 000), et deux sommets délibérément lointains rejoignent le rang cinq : **une année civile entière à 50 % d’épargne** et **cinq ans sans un seul objectif dépassé**. Sur quatre profils simulés, la collection va de 32 % à 43 %, l’exceptionnel restant à une pièce au mieux.
- Deux réglages de justesse au passage. **« Année bissextile » redescend au rang deux** : n’importe quel historique couvrant un 29 février le décroche, c’est une curiosité de calendrier et non une performance. Et un **« poste divisé par deux » demande désormais un poste d’au moins 100 € par mois** — en dessous, un achat exceptionnel l’année d’avant suffit à produire la chute.
...
- Un trophée non acquis garde **son emblème en creux et son arc de progression** sur le contour de l’hexagone, avec le pourcentage parcouru — sauf les défis tout-ou-rien, qui n’ont pas de palier à gravir et restent donc à zéro tant qu’ils ne sont pas décrochés. Il reste une cible, pas un échec — et le survol donne la définition exacte ainsi que le mois du déblocage.
